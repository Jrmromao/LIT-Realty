                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="info-box blue-bg">
                                ...
                                <a href="AgentProperties"><div class="count">${list.size()}</div></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="info-box brown-bg">
                                <i class="fa fa-home"></i>
                                <div class="count">${soldPro.size()}</div>
                                <div class="title">Sold by You</div>
                            </div>
                            <!--/.info-box-->
                        </div>
                        <!--/.col-->
                                    ...
                                    <div class="widget-foot">
                                        ...
                                        <form class="form-inline">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="admin/Type your message here...">
                                            </div>
