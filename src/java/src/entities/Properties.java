...
@NamedQueries({
    ...
    @NamedQuery(name ="Properties.finfDistinct", query = "SELECT DISTINCT p.city from Properties p ORDER BY p.city"),
    ...
    @NamedQuery(name = "Properties.userSeachProp", query = "SELECT p FROM Properties p WHERE p.city = :city AND p.price >  :price AND p.price < :price"),
    @NamedQuery(name = "Properties.GetCity", query = "SELECT DISTINCT p.city FROM Properties p"),
    @NamedQuery(name = "Properties.SearchProp", query = "SELECT p FROM Properties p WHERE p.price > :minPrice AND p.price < :maxPrice AND p.city = :location AND p.typeId = :type"),
    @NamedQuery(name = "Properties.advancedSearchProp", query = "SELECT p from Properties p WHERE p.price = :price AND p.city = :location AND p.typeId = :type AND p.bedrooms = :nBedrooms AND p.squarefeet = :squarefeet"),
    @NamedQuery(name = "Properties.GetAllPropertiesByAgent", query = "Select p from Properties p WHERE p.agentId = :agentID"),
    @NamedQuery(name = "Properties.latestProp", query = "SELECT p from Properties p ORDER BY p.dateAdded DESC"),
    @NamedQuery(name = "Properties.updateStatus", query = "UPDATE Properties p SET p.statusId = :status WHERE p.id = :propId")
