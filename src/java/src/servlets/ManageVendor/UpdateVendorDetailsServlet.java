 ...
 * @author jrmromao
 */
@WebServlet(name = "UpdateVendorDetailsServlet", urlPatterns = {"/UpdateVendorDetailsServlet"})
public class UpdateVendorDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (VendorDB.updateVendor(v)) {
                address = "ManageVendorsServlet";
                alert = "<script>alert(\"vedor details Updated!\");</script>";

            } else {
                alert = "<script>alert(\"ERROR when updating the vendor details!\");</script>";
            }
        ...
        request.setAttribute("alert_manageVendor", alert);
