                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <br>
                                                <h3 class="h3"><u>Remove Vendor</u></h3>
                                                <br>
                                                <form action="DeleteVendorServlet" method="post">
                                                    <select class="form-control" name="id">
                                                        <c:forEach items="${vList}" var="v">
                                                            <option value="${v.getVendorId()}">${v.getVendorId()}</option>

                                                        </c:forEach>
                                                    </select>
                                                    <br>
                                                    <br>
                                                    <input type="submit" class="btn btn-danger" value="Remove" onclick="return confirm('Delete Vendor?')">
                                                </form>

                                                <br>
                                                <br>
                                                <br>
                                                <h3 class="h3"><u>Update Vendor Details</u></h3>
                                                <br>
                                                <form action="FetchVendorData" method="post">
                                                    <select class="form-control" name="id">
                                                        <c:forEach items="${vList}" var="v">
                                                            <option value="${v.getVendorId()}">${v.getVendorId()}</option>
                                                        </c:forEach>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <input type="submit" class="btn btn-primary" value="Get Vendor Data" onclick="return confirm('Fwtch this Vendor Data?')">
                                                </form>
                                            ...
                                            <div class="col-lg-7">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10"> 
                                                                ...
                                                                <c:when test="${vendor == null}">
                                                                    ...
                                                                    <form action="AddVendorServlet" method="post">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" required placeholder="Vendor Name"   name="name">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Vendor Phone Num</label>
                                                                            <input type="number"  class="form-control"  required placeholder="Vendor Phone Number"  name="num">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Vendor Address</label>
                                                                            <input type="text" class="form-control" placeholder="Vender Address"   name="address">
                                                                        </div>
                                                                        <!--|END VENDOR DETAIL|-->

                                                                        <br>
                                                                        <input type="submit" class="btn btn-primary" value="Add Vendor" onclick="return confirm('Add new Vendor?')">
                                                                    </form>

                                                                </c:when>
                                                                <c:otherwise>

                                                                    <form action="UpdateVendorDetailsServlet" method="post">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Vendor Name</label>
                                                                            <input type="text" class="form-control" required    name="name" value="${vendor.getName()}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Vendor Phone Num</label>
                                                                            <input type="text"  class="form-control"  required  name="num" value="${vendor.getPhoneNum()}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Vendor Address</label>
                                                                            <input type="text" class="form-control"   name="address" value="${vendor.getAddress()}">
                                                                        </div>
                                                                        <!--|END VENDOR DETAIL|-->

                                                                        <br>
                                                                        <input type="submit" class="btn btn-primary" value="Update Details" onclick="return confirm('Update Details?')">
                                                                    </form>
                                                                </c:otherwise>
                                                        ...
                                                        <div class="row">
                                                            <h3 class="h3">Registered Vendors</h3>
                                                            <c:forEach items="${vList}" var="v">
                                                                <ul class="list-group">   
                                                                    <li class="list-group-item"><strong>Name: </strong>  ${v.getName()}</li>
                                                                    <li class="list-group-item"><strong>Phone Num: </strong>  ${v.getPhoneNum()}</li>                                                            
                                                                    <li class="list-group-item"><strong>Address:</strong>${v.getAddress()}</li>
                                                                </ul>
                                                            </c:forEach>
