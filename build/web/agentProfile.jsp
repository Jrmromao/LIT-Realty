                            ...
                            <div class="col-lg-9 col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <br>
                                        <br>
                                        <img src="resources/images/agents/${agent.getUserId()}.jpg" width="190" height="200" alt="" />
                                        <br>
                                        <br>
                                        <table class="table">
                                            <tr>
                                        ...
                                        <div class="btn-group">
                                            <a href="EditDetServlet" class="btn btn-default" role="button">Edit Details</a>
                                            <a href="ManagePropServlet" class="btn btn-default" role="button">Manage Properties</a>
                                              <a href="ManageVendorsServlet" class="btn btn-success" role="button">Manage Vendors</a>
                                        </div>
                                        <br>
                                        <br>
