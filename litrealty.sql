...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2018 at 03:12 PM
...
--
-- Dumping data for table `propertyviews`
--

INSERT INTO `propertyviews` (`viewID`, `propID`, `numViews`, `userIP`) VALUES
(267, 7, 1, '192.168.56.1'),
(268, 7, 1, '192.168.56.1'),
(269, 4, 1, '192.168.56.1'),
(270, 9, 1, '192.168.56.1'),
(271, 9, 1, '192.168.56.1');
...
INSERT INTO `user` (`userId`, `name`, `phone`, `fax`, `email`, `username`, `password`, `role`) VALUES
(4, 'Laura Blain', '555-9898', '555-6767', 'laura@homesellers.com', 'Laura.Blain', 'F828CBFDF7536D8B23219629263021785F4B48390C7F1CB47449418CFF378E9D', 1),
(5, 'Dave Lindale', '555-8833', '555-9876', 'dave@homesellers.com', 'Dave.Lindale', 'C0AB909F6A88E98D9E6891DA2013064CC99B51178689431AC2EA1EBCC4720EAE', 1),
(1, 'Sue Roberts', '555-1234', '555-9876', 'sue@homesellers.com', 'Sue.Roberts', 'BA1E9ECE69A4E16D16917E649D517226B9B6B282FBB912BB68FC69F24B80FE61', 0),
(2, 'Natasha Watkins', '555-1357', '555-9876', 'tasha@homesellers.com', 'Natasha.Watkins', 'C5365DD9E63A02FFB495B7DDFBF976CDA085C7A3E7BA24A0FF3D256FCF5ECB8C', 1),
(3, 'Chris Clarkson', '555-2468', '555-6767', 'chris@homesellers.com', 'Chris.Clarkson', '4CF9F10FD304DC885A78E29A95A77DD552CA15E168C06AD62F53830C1E19B929', 0);
...
INSERT INTO `vendor` (`vendorId`, `name`, `phoneNum`, `address`) VALUES
(1, 'Maria Madalena', '0860874189', '94 d Block Bru na Sionna'),
(2, 'Joao Silva', '869875963', 'Inmate 1111-55555555 Guantanamo Bay Detention Camp'),
(3, 'Joao Romaooooooo', '860874569', '93 Block k Shannon'),
(4, 'Mark Franklin', '0854567855', 'Cell 58, Limerick Detention Center, Limerick'),
(5, 'Sue Roberts', '860874189', 'Rua de Moscow, n24, Abrantes, Portugal'),
(7, 'Katie ', '851867479', 'Room 999, Adare Manor, Adare '),
(9, 'Roman del Rio', '874137896', 'Rua del Sol n 56, Madrid, Espana ');
...
--
ALTER TABLE `propertyviews`
  MODIFY `viewID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=272;
--
